...
- `local_segment_template_interpolation`: 61.66 m MAE / 89.21 m RMSE on `val_input_8`
- `local_segment_template_interpolation`: 115.73 m MAE / 163.61 m RMSE on `val_input_16`
